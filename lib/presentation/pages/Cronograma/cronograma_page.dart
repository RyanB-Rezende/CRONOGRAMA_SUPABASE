...
//   if (turmaInfo != null && turmaInfo.cursos?.idcurso != null) {
//     try {
//       final response = await Supabase.instance.client
//           .from('curso')
//           .select('nomecurso')
...
//       nomeCurso = response['nome_curso'] as String;
//     } catch (e) {
  ...
  Future<void> _removerAula(
    ...
    try {
      ...
      if (deleteResponse.error != null) {
        throw Exception(
            'Erro ao excluir aula: ${deleteResponse.error!.message}');
      }

      // Restaurar carga horária da UC
      setState(() {
